...
do
    ...
    do
        ...
        # python3 Utils/overlap_score.py BART data/SubordinationDataSet/gold/test_reduced_IP.coord data/SubordinationDataSet/outputv2/predictions/Predictions_BART_small_b32_v${n2}.txt > data/SubordinationDataSet/outputv2/evaluations/wire57_f1/Result_BART_small_b32_v${n2}_wire57.txt
